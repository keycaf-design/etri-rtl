...
REM
REM Generated by Vivado on Tue Jul 28 19:24:45 +0900 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_simple_dual_port_ram_ctl_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_simple_dual_port_ram_ctl_vlog.prj -log xvlog.log
