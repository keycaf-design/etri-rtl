...
REM
REM Generated by Vivado on Tue Jul 28 15:13:23 +0900 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_single_port_ram_ctl_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_single_port_ram_ctl_vlog.prj -log xvlog.log
