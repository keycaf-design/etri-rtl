...
REM
REM Generated by Vivado on Tue Jul 28 12:02:11 +0900 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_singleportrom_ctl_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_singleportrom_ctl_vlog.prj -log xvlog.log
