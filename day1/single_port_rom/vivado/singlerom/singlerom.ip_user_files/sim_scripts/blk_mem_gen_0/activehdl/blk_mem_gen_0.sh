...
#
# Script generated by Vivado on Tue Jul 28 13:35:11 +0900 2026
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/project/etri/w6/day1/single_port_rom/vivado/singlerom/singlerom.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
